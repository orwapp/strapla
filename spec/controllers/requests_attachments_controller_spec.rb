...
describe Requests::AttachmentsController do
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Attachment" do
        expect {
          ...
          :attachment => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved attachment as @attachment" do
        ...
        post :create, { request_id: 1, 
        :attachment => { "request_id" => "invalid value" }}, valid_session
        assigns(:attachment).should be_a_new(Attachment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested attachment" do
        ...
        put :update, { request_id: 1, :id => attachment.to_param, 
        :attachment => { "request_id" => "1" }}, valid_session
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested attachment" do
      attachment = Attachment.create! valid_attributes
      expect {
        delete :destroy, { request_id: 1, 
        :id => attachment.to_param}, valid_session
      }.to change(Attachment, :count).by(-1)
    end
