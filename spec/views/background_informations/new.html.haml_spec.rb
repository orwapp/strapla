...
describe "background_informations/new" do
  before(:each) do
    assign(:background_information, stub_model(BackgroundInformation,
  ...
  it "renders new background_information form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", background_informations_path, "post" do
