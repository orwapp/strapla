Feature: Comment on a Price Quote
  In order to get all the details right and to keep the communication within Stabstr
  ...
  Scenario: The request owner adds a comment to the price quote
    ...
    And "expert@expert.com" opens the email with subject "New comment on Stabstr"
